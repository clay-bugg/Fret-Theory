      ...
      <div class="controls">
        ...
        <div class="octave-select control">
          ...
          <div class="octave-selector">
            <input
              v-model="octaveAmount"
              :class="{ active: octaveAmount === '1' }"
              type="radio"
            />
            <input
              v-model="octaveAmount"
              :class="{ active: octaveAmount === '2' }"
              type="radio"
              value="2"
            />
            <input
              v-model="octaveAmount"
              :class="{ active: octaveAmount === '3' }"
              type="radio"
              value="3"
            />
          </div>
...
function updateChord() {
  ...
  console.log(
    `Chord: ${rootNote.value}${chordType.value}, Notes: ${chordNotes.value.join(
      ", "
    )}, Intervals: ${formula.join(", ")}`
  );
}
